    ...
    <>
      ...
      <div className="navbar-fixed">
          <nav className="navbar navbar-expand-lg navbar-heading">
            <div className="container-fluid">
              ...
              <div> <img src={Rtc} className="navLogo" />   </div>
      ...
      <div className="consumer-one">
        <div className="container">
          ...
          <h1><b>Grow your business by taking it online</b></h1>
          <h5> We provide a online platform for you to sell your products online and reach it to every home, increase customer base and manage your business.</h5>

          <div className="row imagetiles">

            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
              <img src={FoodDrinkImg} className="img-responsive my-2" />
              <h5 className="text-center image-desc">FOOD AND DRINK </h5>
            </div>
            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
            ...
            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
              <img src={ElectronicImg} className="img-responsive my-2 " />
              <h5 className="text-center"> Electronics</h5>
            </div>
            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
              <img src={JewelaryImg} className="img-responsive my-2" />
              <h5 className="text-center">Jewelary</h5>
            </div>
